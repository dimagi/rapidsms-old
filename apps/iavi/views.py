...
def participants(req):
    ...
    paticipants = StudyParticipant.objects.filter(reporter__location__in=locations).order_by('reporter__alias')
    return render_to_response(req, template_name, {"participants" : paticipants})
